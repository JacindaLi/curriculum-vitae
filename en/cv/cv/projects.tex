...
%---------------------------------------------------------
  \cventry
    {Chief Programmer} % Role
    {Annotator \href{http://mark.17zuoye.net/}{[\underline{Link}]}} % Title
    {Beijing, China} % Location
...
%---------------------------------------------------------
  \cventry
    {Solo} % Role
    {AI Course Projects \href{https://github.com/yanshengjia/artificial-intelligence}{[\underline{Link}]}} % Title
    {Nanjing, China} % Location
